...
const seedDatabase = async () => {
  try {
    ...
    const restaurantB = await Restaurant.create({
      ...
      restaurantCode: 'REST-00002',
      address: { street: '12 MG Road', city: 'Bengaluru', state: 'Karnataka', pincode: '560001', country: 'India', lat: 12.9716, lng: 77.5946 },
    ...
    const restaurantC = await Restaurant.create({
      ...
      restaurantCode: 'REST-00003',
      address: { street: '88 Koramangala 8th Block', city: 'Bengaluru', state: 'Karnataka', pincode: '560095', country: 'India', lat: 12.9352, lng: 77.6245 },
